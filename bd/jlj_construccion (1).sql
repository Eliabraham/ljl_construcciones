...
--
-- Servidor: localhost
-- Tiempo de generación: 26-01-2023 a las 06:35:03
...
--
-- Base de datos: `jlj_construccion`
--
...
CREATE TABLE `our_company` (
  ...
  `c_description` varchar(350) COLLATE utf8mb4_spanish_ci NOT NULL,
  `mostrar_file` varchar(2) COLLATE utf8mb4_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
...
CREATE TABLE `tb_category` (
  ...
  `ct_description` varchar(350) COLLATE utf8mb4_spanish_ci NOT NULL,
